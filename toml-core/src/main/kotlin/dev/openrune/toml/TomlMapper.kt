...
import dev.openrune.toml.configuration.attachExtensionSettings
import dev.openrune.toml.model.TomlValue
import dev.openrune.toml.model.merge
...
class TomlMapper internal constructor(
     ...
     * If the value can't be encoded, a [dev.openrune.toml.model.TomlException.EncodingError] is thrown.
     *
     ...
     * If the value can't be decoded into the target type, a [dev.openrune.toml.model.TomlException.DecodingError]
     * is thrown.
     *
...
private fun tomlMapper(
    ...
    return TomlMapper(encoder, decoder).also { mapper ->
        attachExtensionSettings(configurator, mapper)
    }
}
